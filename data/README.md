...
1
		NO3
human DNA polymerase lambda lyase domain 	
...
phage T4 lysozyme M102K mutant 	
...
1
	  	Not used in this study due to the methylated residue 1 and disordered CTR
Thioredoxin (reduced) 	
...
1
		BMA,FUC,GAL,GLC,MAN,NAG –  complex structure
		1TUR 	NMR 	
...
4
		XYP,XYS, residue 1 changed from Glu to Gln
		1QH6 	X-ray 	
...
Bold: PDB files used for the dataset with 1 X-ray structure/protein.
